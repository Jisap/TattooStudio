...
const container = {
  ...
  show: {
    transition: {
      staggerChildren: 0.1, // establece un tiempo de retraso entre la transición de cada uno de los elementos hijos
      delayChildren: 0.6,   // establece un retraso antes de comenzar la transición de los elementos hijos.
    },
  },
};  // produce un efecto de entrada en cascada para los elementos hijos 
